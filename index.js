...
app.get("/api/v1/employed", (req, res, next) => {
...
app.get("/api/v1/employed/:id", (req, res, next) => {
...
app.patch("/api/v1/employed/:id", (req, res, next) => {
    var data = {
        name: req.body.name,
        email: req.body.email,
        phone: req.body.phone,
...
app.delete("/api/v1/employed/:id", (req, res, next) => {
    db.run(
